    ...
    <div className="min-h-[100dvh] bg-[#FAFAFA] flex flex-col">
      ...
      <div className="flex-1 min-h-0 flex items-center justify-center px-4 pb-6">
        <div
          ...
          className="relative h-full max-h-[680px] w-auto max-w-full aspect-[2/3] rounded-[1.75rem] overflow-hidden shadow-xl border border-violet-200 select-none touch-none cursor-pointer"
        >
