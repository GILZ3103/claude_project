...
QUALITY_BLUR_THRESHOLD = 100        # Laplacian variance — higher = sharper
...
# 0.25 = face fills 25% of frame width (about arm's length on a 7" kiosk screen)
...
MAX_POSE_DEGREES = 30               # Reject faces tilted more than 30° yaw/pitch
MIN_LANDMARK_VISIBILITY = 0.90      # 90% of landmarks must be visible
...
THRESHOLD_CONFIRMED = 0.65          # >= this → confirmed match
