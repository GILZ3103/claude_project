...
QUALITY_BLUR_THRESHOLD = 20         # Laplacian variance — laptop webcam at desk distance
...
# 0.10 = laptop webcam at desk distance; was 0.25 for kiosk arm's-length (Arducam)
...
MAX_POSE_DEGREES = 40               # Reject faces tilted more than 40° yaw/pitch (laptop webcam)
MIN_LANDMARK_VISIBILITY = 0.70      # 70% of landmarks must be visible (laptop webcam)
